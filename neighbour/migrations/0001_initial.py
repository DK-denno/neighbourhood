    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, to='neighbour.Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='neighbour.Neighbourhoods')),
        ...
        migrations.AddField(
            model_name='comments',
            name='message',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comm', to='neighbour.Message'),
        ),
        migrations.AddField(
            model_name='comments',
            name='user',
